 ...
 * @author user
 */
public class CustomerAdd1 extends javax.swing.JFrame {
...
void clearFields() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerAdd1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerAdd1().setVisible(true);
            }
        });
    }
