 ...
 * @author user
 */
public class CustomerEdit1 extends javax.swing.JFrame {
   ...
   // Connection conn = null;
    ...
    private void initComponents() {
        ...
        CheckRegular.setBackground(new java.awt.Color(0, 0, 102));
...
void clearFields() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerEdit1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerEdit1().setVisible(true);
            }
        });
    }
