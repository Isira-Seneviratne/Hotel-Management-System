...
//            while(rs.next())
//            {
//                eid = rs.getString("Admin_ID");
//                pwd = rs.getString("Password");
//            }
//            pst = conn.prepareStatement("Select * from employee where Emp_ID='"+eid+"'");
//            while(rs.next())
//            {
//                fname = rs.getString("full_name");
//                iname = rs.getString("name_with_Initial");
//            }
//            if (txt_loginuserName.getText().equals(eid) && new String(txt_loginpassword.getPassword()).equals(pwd)) {
//
//                if (job.equals("Admin")) {
//                    
