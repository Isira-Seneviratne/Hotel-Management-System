...
public class CleaningItems extends javax.swing.JPanel implements ListSelectionListener {
    ...
    public void loadTableAndComboBox() {
        ...
        try {
            jTable1.setModel(StockManagement.DBFunctions.getTableRecords("Stock_Cleaning_Items"));
        ...
        try {
            ResultSet vendorIDs = StockManagement.DBFunctions.getSpecificFieldsFromTable("Stock_Vendor_Details",
                    "`Vendor ID`");
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 210, -1, -1));
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        ...
        if (cmbVendorID.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(this, "Select the vendor ID this item belongs to.", "Vendor ID not selected",
        ...
        try {
            ...
            //The JDateChooser class does not have a requestFocus() method, so it was not used here.
            return;
        }
        
        try {
            String itemID = StockManagement.DBFunctions.generateIDForRecord("C", "Stock_Cleaning_Items");
            String insert = "'"+itemID+"', '"+itemName+"', "+qty+", "+price+", '"+vendorID+"', '"
                    +new java.sql.Date(purDate.getTime())+"'";
            StockManagement.DBFunctions.insertRecord("Stock_Cleaning_Items", insert);
            loadTableAndComboBox();
        } catch (SQLException e) {
